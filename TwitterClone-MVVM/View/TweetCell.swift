...
//  TwitterClone-MVVM
//
//  Created by Burak YAZICI on 04/07/2022.
//
...
class TweetCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let stack = UIStackView(arrangedSubviews: [infoLabel,captionLabel, commentButton])
        stack.axis = .vertical
        ...
        actionStack.anchor(bottom: bottomAnchor, paddingBottom: 0)
